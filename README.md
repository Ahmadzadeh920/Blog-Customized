...
# Introduction
 The main goal of this project is to show you how we can use django rest api to create a base blog app with customized authentications(JWT and Token) and all base needs.
