...
class RequestPasswordReset(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        if not user: 
            ...
            Email_obj= EmailMessage('email/reset_password.tpl', data , from_email, to= [email])
            EmailThread(Email_obj).start()
...
class RequestPasswordResetJWT(generics.GenericAPIView):
    ...
    def post(self,request, *args, **kwargs):
        ...
        Email_obj= EmailMessage('email/reset_password.tpl', data , from_email, to= [serializer.validated_data["email"]])
        EmailThread(Email_obj).start()
