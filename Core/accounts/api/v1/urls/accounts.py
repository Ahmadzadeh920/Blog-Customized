...
urlpatterns = [ 
    ...
    path('token/reset/<str:token>/',views.ResetPassword.as_view(), name = "Token_reset_password"),
    # change password
    ...
    path('resend_activation/', views.ChangePasswordView.as_view(), name='auth_change_password'),
    
    #Reset password with JWT authentication
   path('token/reset/request/jwt',views.RequestPasswordResetJWT.as_view(), name = "Token_reset_password_request_jwt"),
   # this url for activate accounts after registeration 
   path('activate/jwt/<str:token>',views.ActivationAccountJWT.as_view(), name = "activation_account_jwt"),
   path('activate/jwt/resend/',views.ResendActivationAccountJWT.as_view(), name = "resend_activation_account_jwt"),
